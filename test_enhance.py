...
from models.pln_model_inc import build_model
...
def parse_args():
    ...
    parser.add_argument('--visualize_num', type=int, default=10,
                       help='要可视化的图片数量')
    parser.add_argument('--visualize_dir', type=str, default='./visualizations_inc',
                       help='可视化结果保存目录')
    parser.add_argument('--save_results', action='store_true',
                       help='是否保存评估结果到JSON文件')
    parser.add_argument('--results_dir', type=str, default='./results_inc',
                       help='评估结果保存目录')
